									...
									<tbody>
										<c:forEach items="${listUser}" var="user">
											<tr>
												...
												<td>
														<a href="users?action=edit&id=${user.id}" class="btn btn-sm btn-primary">Sửa</a>
														<!-- btn-xoa" id-user="${user.id}" -->
														<a href="users?action=delete&id=${user.id}" class="btn btn-sm btn-danger" >Xóa</a> 
