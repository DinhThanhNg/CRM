                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach items="${listProject}" var="project">
                                    	<tr>
                                            ...
                                            <td>
                                                <a href="project?action=edit&id=${project.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="project?action=delete&id=${project.id}" class="btn btn-sm btn-danger">Xóa</a>
